 ...
 */
class LanguagePrefixTest extends FunctionalTest
{
    
    public static $fixture_file = 'languageprefix/tests/LanguagePrefixTest.yml';
    ...
    protected $requiredExtensions = array(
        'SiteTree' => array('Translatable','LanguagePrefix'),
    ...
    public function testLocaleGetParamRedirectsToTranslation()
    {
        ...
        $response = $this->get($origPage->Link());
        ...
        $response = $this->get(Controller::join_links($origPage->Link(), '?locale=fr_FR'));
    ...
    {
        $origObj = $this->objFromFixture('LanguagePrefixTest_Page', 'testpage_en');
        
        $translatedObj = $origObj->createTranslation('fr_FR');
        $translatedObj->LanguagePrefixProperty = 'fr_FR';
        $translatedObj->write();
        
        $this->assertEquals(
            $origObj->LanguagePrefixProperty,
            'en_US',
            'Creating a translation doesnt affect database field on original object'
        );
        $this->assertEquals(
            $translatedObj->LanguagePrefixProperty,
            'fr_FR',
    ...
    {
        $origObj = $this->objFromFixture('LanguagePrefixTest_DataObject', 'testobject_en');
        $translatedObj = $origObj->createTranslation('fr_FR');
        $translatedObj->LanguagePrefixProperty = 'fr_FR';
        $translatedObj->LanguagePrefixDecoratedProperty = 'fr_FR';
        $translatedObj->write();
        ...
        $this->assertEquals(
            $origObj->LanguagePrefixDecoratedProperty,
            'en_US',
        ...
        $this->assertEquals(
            $translatedObj->LanguagePrefixDecoratedProperty,
            'fr_FR',
...
DataObject::add_extension('LanguagePrefixTest_DataObject', 'LanguagePrefixTest_Extension');
